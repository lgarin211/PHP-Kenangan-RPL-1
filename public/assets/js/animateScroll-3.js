{
    ...
    class Item {
        constructor(el) {
            // the .item element
            this.DOM = { el: el };
            this.DOM.image = this.DOM.el.querySelector('.content__item-imgwrap');
            this.DOM.imageWrapper = this.DOM.image;
            // 3d stuff
    ...
    class SmoothScroll {
        constructor() {
            ...
            this.items = [];
            this.DOM.content = this.DOM.main.querySelector('.animate-item-wrap');
