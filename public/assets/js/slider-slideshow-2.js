...
$('.slides> .slide:first').addClass("slide--current");
...

{
  ...
  function debounce(func, wait, immediate) {
	...
	new Slideshow(document.querySelector('.slideshow-slider'));
	imagesLoaded('.slide__img', { background: false}, () => document.body.classList.remove('loading'));
};